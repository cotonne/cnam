...
DappInput=Entree(1:209,[1 2 5 10 11 12]); % Learning input
DappOutput=Sortie(1:209); % Learning output
DvalInput=Entree(210:244,[1 2 5 10 11 12]); % Validation input
DvalOutput=Sortie(210:244); % Validation output
DtestInput=Entree(245:268,[1 2 5 10 11 12]); % Test input
...
YLearningCalculee = mlpfwd(Net_meilleur2,Xapp);
arv_app= mean((Yapp-YLearningCalculee).^2)/variance_data_sunspots
YValidationCalculee = mlpfwd(Net_meilleur2,Xval);
arv_val=mean((Yval-YValidationCalculee).^2)/variance_data_sunspots
YTestCalculee = mlpfwd(Net_meilleur2, Xtest);
...
pause
NetSunspots=mlpfwd(Net_meilleur2,Entree(:,[1 2 5 10 11 12]));
