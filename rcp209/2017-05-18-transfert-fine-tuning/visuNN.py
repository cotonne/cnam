...
# Supprimer la couche softmax
model.pop()
# supprimer la couche de sortie
model.pop()
model.summary()

(batch, labels) =(X_test[0:1000], y_test[0:1000])
y_predict = model.predict(batch)

# Computing convex hulls
convex_hulls= convexHulls(y_predict, labels)
# Computing best fitting ellipses
ellipses = best_ellipses(y_predict, labels)
# Computing Neighborhooad Hit
nh = neighboring_hit(y_predict, labels)

visualization(y_predict, labels, convex_hulls, ellipses , "", nh)
