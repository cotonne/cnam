...
tuned_parameters = {'hidden_layer_sizes':[(5,), (20,), (50,), (100,), (150,), (200,), (250,), (300,)],
                    'alpha':   [0.001, 0.01, 1, 2, 5]}

# On peut avoir l'ensemble des parametres que l'on peut utiliser pour 
# le tuning des hyperparametres via :
# clf.get_params()
clf = GridSearchCV(MLPClassifier(solver='lbfgs', alpha=1),
  tuned_parameters, 
  cv=5
  #,n_jobs=8
  )
...
n_hidden = np.array([5, 20, 50, 100, 150, 200, 250, 300])
alphas = np.array([0.001, 0.01, 1, 2, 5])
